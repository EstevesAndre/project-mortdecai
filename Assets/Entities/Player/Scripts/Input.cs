...
public class @Input : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""UI"",
                    ""type"": ""Button"",
                    ""id"": ""d6c7a7a8-24cf-4a21-8e50-5f96e2d2d2e2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""8aa2e8a4-c2bc-4090-95ab-c048a148e923"",
    ...
    private readonly InputAction m_Player2D_UI;
    public struct Player2DActions
    {
        ...
        public InputAction @UI => m_Wrapper.m_Player2D_UI;
        ...
        public void SetCallbacks(IPlayer2DActions instance)
        {
            if (m_Wrapper.m_Player2DActionsCallbackInterface != null)
            {
                ...
                @UI.started -= m_Wrapper.m_Player2DActionsCallbackInterface.OnUI;
                @UI.performed -= m_Wrapper.m_Player2DActionsCallbackInterface.OnUI;
                @UI.canceled -= m_Wrapper.m_Player2DActionsCallbackInterface.OnUI;
            }
